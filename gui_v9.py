...
class DevicePanel(ttk.Frame):
    ...
    def _build_ui(self):
        ...
        # --- YENİ: HEX CSV dosyasını aç butonu ---
        btnrow = ttk.Frame(mon); btnrow.pack(fill='x', padx=8, pady=(4,0))
        ttk.Button(btnrow, text="Open HEX CSV", command=self.open_hex_csv, style="Tool.TButton").pack(side='left')
